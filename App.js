...
function App() {
  ...
  let [arrDonation, setArrDonation] = useState([
    { name: "אסתי פישהוף", amount: 350, note: "ללידה קלה...", date: new Date("2023-12-8"), id: 2 },
    { name: "דבורי גולדנברג", amount: 600, note: "הצלחה בצילומי חוץ...", date: new Date("2023-11-17"), id: 3 },
    { name: "שרה קנזי", amount: 400, note: "הצלחה בפרוייקט", date: new Date("2023-12-9"), id: 1 },
    { name: "התורם האגדי", amount: 30000, note: "החפץ בעילום שמו", date: new Date("2023-12-10"), id: 4 },
  ]);
  ...
  return (<>
    <ThemeProvider theme={buttonOfStyle === "day" ? dayStyle : nightStyle}>
      <MyCurrency.Provider value={currency} >
        ...
        //////////////////
        <Routes>
          <Route path="/Home" element={<Home buttonOfStyle={buttonOfStyle} arr={arrDonation} setArr={setArrDonation} />}></Route>
