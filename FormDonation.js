...
return (<>
    ...
    <CacheProvider value={cacheRtl}>
        <Box
            component="form" onSubmit={sendForm} sx={{ '& .MuiTextField-root': { m: 1, width: '25ch' } }} noValidate autoComplete="off">
            ...
            {/* <Box sx={{ display: 'flex', alignItems: 'center', m: 3, position: 'relative' }}>
                    <Button
                        variant="contained"
                        // sx={buttonSx}
                        disabled={calcAmountToTarget ? loading : true}
                        onClick={sendForm}
                        startIcon={<SendIcon />}
